            ...
            <div class="row">
                <div class="col-12 col-md-4">
                    ...
                    <select id="date_format" name="date_format">
                        <option @if (config('website_settings.date_format') === 'DD-MM-YYYY') selected @endif  value="DD-MM-YYYY">DD-MM-YYYY</option>
                        <option @if (config('website_settings.date_format') === 'MM-DD-YYYY') selected @endif  value="MM-DD-YYYY">MM-DD-YYYY</option>
                    </select>
                </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <select id="clock_type" name="clock_type">
                        <option @if (config('website_settings.clock_type') === '24') selected @endif value="24">24 Horas</option>
                        <option @if (config('website_settings.clock_type') === '12') selected @endif value="12">12 Horas (AM/PM)</option>
                    </select>
                </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <select id="timezone" name="timezone">
                        @foreach (DateTimeZone::listIdentifiers() as $timezone)
                            <option @if (config('website_settings.timezone') === $timezone) selected @endif value="{{ $timezone }}">{{ $timezone }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
